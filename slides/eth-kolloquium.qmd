...
# #10 Funding for Open Research Data exists {background-image="img/eth-kolloquium/silhouette.jpg" background-color="#000000"}
...
Access slides as [PDF on GitHub](https://github.com/global-health-engineering/website/raw/main/slides/eth-kolloquium.pdf)

All material is licensed under [Creative Commons Attribution Share Alike 4.0 International](https://creativecommons.org/licenses/by-sa/4.0/).

## References  {background-color="#ede8d0"}
