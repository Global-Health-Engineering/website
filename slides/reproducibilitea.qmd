...
- Launched by the Vice Presidents for Research and Infrastructure
- Goal: accelerate FAIR for code, data, notes, metadata, images
- Coalition Charter open for researchers and staff to sign
- Research units invited to formally join in spring 2026
- Four initiatives launching summer 2026, including embedding FAIR in research units and a FAIR summit
...
ghe_repos |>
  dplyr::count(created_year, publication_type) |>
  ggplot(aes(x = factor(created_year), y = n, fill = publication_type)) +
  geom_col() +
  ...
  labs(
    ...
    subtitle = "Open code, open data, open publications, by year created",
    x = NULL,
    y = "Number of public repositories",
    fill = "Repository type:"
  ) +
  scale_fill_colorblind() +
...
- Talk at RDC 2026 (Swiss Research Data Support Network): "Embedded data stewardship and research intelligence: five years of practice at a research group at ETH Zurich"

::: footer
Abstract: <https://github.com/larnsce/rdc-2026/blob/main/abstract-talk.md>
:::
