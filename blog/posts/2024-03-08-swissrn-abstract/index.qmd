...
subtitle: "Slides and submitted abstract for Swiss Reproducibility conference 2024"
author:
  - name: Lars Schöbitz
    url: https://lse.de/
...
[View slides in full screen](../../../slides/swissrn.html) | [Download slides as PDF](https://github.com/Global-Health-Engineering/website/blob/main/slides/swissrn.pdf)

```{=html}
<iframe class="slide-deck" src="../../../slides/swissrn.html" height="420" width="747" style="border: 1px solid #123233;"></iframe>
```
